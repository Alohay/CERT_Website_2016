...
<![endif]-->
<link rel="stylesheet" href="/1/CERT_Website_2016/web/back-end/public/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/1/CERT_Website_2016/web/back-end/public/simpleboot/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
...
var GV = {
    ...
    DIMAUB: "",
    JS_ROOT: "/1/CERT_Website_2016/web/back-end/public/js/",
    TOKEN: ""
};
</script>
...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<img src="/1/CERT_Website_2016/web/back-end/admin/themes/simplebootx/Public/assets/images/logo-18.png">
						CERT <?php echo L('ADMIN_CENTER');?>
				</small>
				</a>
				<div class="pull-left nav_shortcuts" >
					
					<a class="btn btn-small btn-warning" href="/1/CERT_Website_2016/web/back-end/" title="<?php echo L('WEBSITE_HOME_PAGE');?>" target="_blank">
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							...
							<?php else: ?>
								<img class="nav-user-photo" width="30" height="30" src="/1/CERT_Website_2016/web/back-end/admin/themes/simplebootx/Public/assets/images/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>"><?php endif; ?>
	...
	<script src="/1/CERT_Website_2016/web/back-end/admin/themes/simplebootx/Public/assets/js/index.js"></script>
</body>
</html>