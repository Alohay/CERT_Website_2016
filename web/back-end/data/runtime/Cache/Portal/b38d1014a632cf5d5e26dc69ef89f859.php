<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
    ...
    <![endif]-->
	<link rel="icon" href="/1/CERT_Website_2016/web/back-end/themes/simplebootx/Public/images/favicon.ico" type="image/x-icon">
	<link rel="shortcut icon" href="/1/CERT_Website_2016/web/back-end/themes/simplebootx/Public/images/favicon.ico" type="image/x-icon">
    <link href="/1/CERT_Website_2016/web/back-end/themes/simplebootx/Public/simpleboot/themes/simplebootx/theme.min.css" rel="stylesheet">
    <link href="/1/CERT_Website_2016/web/back-end/themes/simplebootx/Public/simpleboot/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet">
    <link href="/1/CERT_Website_2016/web/back-end/themes/simplebootx/Public/simpleboot/font-awesome/4.4.0/css/font-awesome.min.css"  rel="stylesheet" type="text/css">
	<!--[if IE 7]>
	<link rel="stylesheet" href="/1/CERT_Website_2016/web/back-end/themes/simplebootx/Public/simpleboot/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
	<![endif]-->
	<link href="/1/CERT_Website_2016/web/back-end/themes/simplebootx/Public/css/style.css" rel="stylesheet">
	<style>
		...
		<link href="/1/CERT_Website_2016/web/back-end/themes/simplebootx/Public/css/slippry/slippry.css" rel="stylesheet">
		<style>
...
<div class="navbar navbar-fixed-top">
   <div class="navbar-inner">
     <div class="container">
       ...
       <a class="brand" href="/1/CERT_Website_2016/web/back-end/"><img src="/1/CERT_Website_2016/web/back-end/themes/simplebootx/Public/images/logo.png"/></a>
 ...
 $effected_id="main-menu"; $filetpl="<a href='\$href' target='\$target'>\$label</a>"; $foldertpl="<a href='\$href' target='\$target' class='dropdown-toggle' data-toggle='dropdown'>\$label <b class='caret'></b></a>"; $ul_class="dropdown-menu" ; $li_class="" ; $style="nav"; $showlevel=6; $dropdown='dropdown'; echo sp_get_menu("main",$effected_id,$filetpl,$foldertpl,$ul_class,$li_class,$style,$showlevel,$dropdown); ?>
		...
		<ul class="nav pull-right" id="main-menu-user">
			<li class="dropdown user login">
	            ...
	            <img src="/1/CERT_Website_2016/web/back-end/themes/simplebootx//Public/images/headicon.png" class="headicon" id="avatar_small"/>
          	...
          	<li class="dropdown user offline">
	            <a class="dropdown-toggle user" data-toggle="dropdown" href="#">
	           		<img src="/1/CERT_Website_2016/web/back-end/themes/simplebootx//Public/images/headicon.png" class="headicon"/>登录<b class="caret"></b>
	            </a>
	            <ul class="dropdown-menu pull-right">
				...
				<div class="header">
					<div class="item-image">
						<a href="<?php echo leuu('article/index',array('id'=>$vo['tid'],'cid'=>$vo['term_id']));?>">
							<?php if(empty($smeta['thumb'])): ?><img src="/1/CERT_Website_2016/web/back-end/themes/simplebootx/Public/images/default_tupian1.png" class="img-responsive" alt="<?php echo ($vo["post_title"]); ?>"/>
							<?php else: ?> 
...
<!-- Le javascript
    ...
    <script src="/1/CERT_Website_2016/web/back-end/themes/simplebootx/Public/simpleboot/bootstrap/js/bootstrap.min.js"></script>
    <script src="/1/CERT_Website_2016/web/back-end/public/js/frontend.js"></script>
	<script>
	$(function(){
		...
		$.post("<?php echo U('user/index/is_login');?>",{},function(data){
			if(data.status==1){
				if(data.user.avatar){
					$("#main-menu-user .headicon").attr("src",data.user.avatar.indexOf("http")==0?data.user.avatar:"/1/CERT_Website_2016/web/back-end/data/upload/avatar/"+data.user.avatar);
				}
...
<script src="/1/CERT_Website_2016/web/back-end/themes/simplebootx/Public/js/slippry.min.js"></script>
<script>
$(function() {
